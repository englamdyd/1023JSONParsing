package com.example.a503_16.a1023jsonparsing;
...
public class DetailActivity extends AppCompatActivity {
    ...
    class ThreadEx extends Thread{
        ...
        public void run(){
            ...
            try{
                //다운로드 받을 주소 생성
                URL url = new URL("http://192.168.0.110:8080/android/getitem?itemid=" + itemid);
                //Connection 만들기
            ...
            try{
                ...
                //사진이 없으면 null이 출력 따라서 null일 때 토스트를 띄운다거나 하는 코드 추가...
    ...
    class ImgThread extends Thread{
        ...
        public void run(){
            try {
                InputStream is =
                        new URL("http://192.168.0.201:8080/android/img/" + filename).openStream();
